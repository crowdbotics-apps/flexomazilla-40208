"""
Django settings for restless_snow_40208 project.
...
ROOT_URLCONF = 'restless_snow_40208.urls'
...
WSGI_APPLICATION = 'restless_snow_40208.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_snow_40208 API",
    "DESCRIPTION": "API documentation for restless_snow_40208 App",
    "VERSION": "v1",
}
